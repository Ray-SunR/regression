...
class XODOutputOptions(XPSOutputCommonOptions):
    ...
    def SetThumbnailSize(self, size):
        return _PDFNetPython.XODOutputOptions_SetThumbnailSize(self, size)
...
class BorderStyle(_object):
    ...
    def SetHR(self, hr):
        return _PDFNetPython.BorderStyle_SetHR(self, hr)

    def GetVR(self):
        return _PDFNetPython.BorderStyle_GetVR(self)

    def SetVR(self, vr):
        return _PDFNetPython.BorderStyle_SetVR(self, vr)
...
class SDFDoc(_object):
    ...
    def ImportObjs(self, obj_list):
        return _PDFNetPython.SDFDoc_ImportObjs(self, obj_list)
...
class Annot(_object):
    ...
    def RefreshAppearance(self):
        return _PDFNetPython.Annot_RefreshAppearance(self)
...
class PDFNet(_object):
    ...
    if _newclass:
        ConnectToCloud = staticmethod(_PDFNetPython.PDFNet_ConnectToCloud)
    else:
        ConnectToCloud = _PDFNetPython.PDFNet_ConnectToCloud
...
def PDFNet_ConnectToCloud(username, password, demo_mode=False):
    return _PDFNetPython.PDFNet_ConnectToCloud(username, password, demo_mode)
...
def PDFNet_SetDefaultDeviceCMYKProfile(icc_filename):
    return _PDFNetPython.PDFNet_SetDefaultDeviceCMYKProfile(icc_filename)
PDFNet_SetDefaultDeviceCMYKProfile = _PDFNetPython.PDFNet_SetDefaultDeviceCMYKProfile

def PDFNet_SetDefaultDeviceRGBProfile(icc_filename):
    return _PDFNetPython.PDFNet_SetDefaultDeviceRGBProfile(icc_filename)
...
class PDFView(_object):
    ...
    def SetDeviceDPI(self, dpi, scale_factor):
        return _PDFNetPython.PDFView_SetDeviceDPI(self, dpi, scale_factor)
